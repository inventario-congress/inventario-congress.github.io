const es = {
  ...
  bulkMove: {
    systemMenuLabel: 'Movimientos Masivos',
    title: 'Movimientos Masivos',
    venueLabel: 'Venue',
    venuePlaceholder: 'Selecciona un venue...',
    venueEmpty: 'No hay venues disponibles.',
    roomTableHeader: 'Sala: {roomName}',
    ...
    dialogs: {
      moveSelection: {
        ...
        searchLabel: 'Venue de destino',
        searchPlaceholder: 'Selecciona un venue...',
        roomLabel: 'Sala de destino',
        roomSearchPlaceholder: 'Selecciona una sala...',
        roomsNoneAssociated: 'No hay salas asociadas a este venue.',
        moveDisabledReason: 'Selecciona un venue y una sala para habilitar mover',
        empty: 'No hay venues disponibles.',
